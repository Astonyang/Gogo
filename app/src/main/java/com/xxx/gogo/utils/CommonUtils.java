...
public final class CommonUtils {
    private static final int NET_OFF = 0;    //无网络
    private static final int NET_UNKNOWN = 1;    //未知网络
    private static final int NET_WIFI = 2;    //WIFI网络
    private static final int NET_2G = 4;    //2G网络
    private static final int NET_3G = 8;    //3G网络
    private static final int NET_4G = 16;   //4G网络
    private static final int NET_EXCEPTION = 32;   //获取网络状态失败
    ...
    public static Drawable getStateListDrawable(int normalColor, int pressedColor){
        StateListDrawable drawable = new StateListDrawable();
        int pressed = android.R.attr.state_pressed;

        drawable.addState(new int[]{pressed}, new ColorDrawable(pressedColor));
